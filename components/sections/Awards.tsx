        ...
        <Reveal className="mb-12 md:mb-16">
          <div className="space-y-4 text-center">
            ...
            <p className="mx-auto max-w-3xl text-ink-muted">
              Sao zählt zu den weltweit gefeiertsten vietnamesischen
              Restaurants. Vom Michelin-Stern bis zu Erwähnungen in
              internationaler Presse — jede Anerkennung spiegelt die Hingabe
              unseres Teams wider, Tradition zu ehren und vietnamesische Küche
              zugleich weiterzudenken.
            </p>
          </div>
        </Reveal>
