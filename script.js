                    ...
                    <div class="contact-items">
                        <div class="contact-item">
                            ...
                            <div class="contact-item-text">
                                ...
                                <span>Königstraße 42, 12351 Berlin</span>
                            </div>
                        </div>
                        <div class="contact-item">
                            <div class="contact-item-icon">📞</div>
    ...
    <footer>
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-column"><h4>Kontakt</h4><a href="#">Sprachschule 12</a><a href="#">12351 Berlin</a><a href="#">+49 3301 987654</a></div>
            </div>
            <div class="footer-bottom">
        ...
        <div class="container">
            <div class="contact-grid">
                <div class="contact-card">
                    ...
                    <h4>Adresse</h4>
                    <p>Berliner Straße 55<br>12351 Berlin</p>
                </div>
                <div class="contact-card">
                    <div class="contact-card-icon">📞</div>
                    <h4>Telefon</h4>
    ...
    <footer>
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-column"><h4>Kontakt</h4><a href="#">Berliner Str. 55</a><a href="#">12351 Berlin</a><a href="#">+49 3301 456789</a><a href="#">info@weber-partner.de</a></div>
            </div>
            <div class="footer-bottom">
        ...
        <div class="container">
            <div class="contact-grid">
                <div class="contact-info">
                    ...
                    <div class="contact-items">
                        <div class="contact-item"><div class="contact-item-icon">📍</div><div class="contact-item-text"><strong>Adresse</strong><span>Schlossplatz 12, 12351 Berlin</span></div></div>
    ...
    <footer>
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-column"><h4>Kontakt</h4><a href="#">Schlossplatz 12</a><a href="#">12351 Berlin</a><a href="#">+49 3301 123456</a><a href="#">hallo@cafe-sonnenschein.de</a></div>
            </div>
            <div class="footer-bottom">
        ...
        <div class="container">
            <div class="contact-grid">
                <div class="contact-info">
                    ...
                    <div class="contact-items">
                        <div class="contact-item"><div class="contact-item-icon">📍</div><div class="contact-item-text"><strong>Adresse</strong><span>Gartenweg 15, 12351 Berlin</span></div></div>
    ...
    <footer>
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-column"><h4>Kontakt</h4><a href="#">Gartenweg 15</a><a href="#">12351 Berlin</a><a href="#">+49 3301 987654</a><a href="#">info@gruenblatt.de</a></div>
            </div>
            <div class="footer-bottom">
        ...
        <div class="container">
            <div class="contact-grid">
                <div class="contact-info">
                    ...
                    <div class="contact-items">
                        <div class="contact-item"><div class="contact-item-icon">📍</div><div class="contact-item-text"><strong>Standort</strong><span>Innovationspark 7, 12351 Berlin</span></div></div>
